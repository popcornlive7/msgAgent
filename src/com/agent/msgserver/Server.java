...
public class Server implements Runnable {
	...
	public void run() {    
		...
		System.out.println("server call run!!");
		// 셀렉터 설정    
	...
	private void accept(Selector selector, SelectionKey key) {    
		try {      
    		System.out.println("server call accept!!");
			// 키 채널을 가져온다.      
	...
	private void receive(Selector selector, SelectionKey key) {    
		try {      
    		System.out.println("server call receive!!");
			// 키 채널을 가져온다.      
	...
	private void send(Selector selector, SelectionKey key) {    
		try {
    		System.out.println("server call send!!");
			// 키 채널을 가져온다.      
			SocketChannel channel = (SocketChannel) key.channel();
			// 채널 Non-blocking 설정      
			channel.configureBlocking(false);
